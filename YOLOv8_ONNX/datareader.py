...
# Ref: https://github.com/microsoft/onnxruntime-inference-examples/blob/main/quantization/image_classification/cpu/resnet50_data_reader.py
...
def _preprocess_images(images_folder: str, height: int, width: int, size_limit=0):
    ...
    """
    image_names = filter(lambda x: x[0] != '.', os.listdir(images_folder))
    ...
    for image_name in batch_filenames:
        ...
        input_data /= 255.
        #input_data -= numpy.array([123.68, 116.78, 103.94], dtype=numpy.float32)
